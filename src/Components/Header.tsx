...
export default function Header() {
    ...
    return (
        <header className="w-full border-b border-gray-200 flex justify-end items-center px-4 sm:px-6 py-3 sm:py-4 bg-stone-50 dark:bg-zinc-800 dark:text-stone-50 text-zinc-800 sticky top-0 z-50 dark:border-zinc-700">
